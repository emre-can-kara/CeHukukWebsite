                ...
                <div className="grid lg:grid-cols-3 gap-12">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="text-gray-700 leading-relaxed space-y-4">
                            <p>
                                Anlaşmalı boşanma protokolünün hazırlanması ya da çekişmeli boşanma davalarının yürütülmesi, evlilikte mal rejimi sözleşmelerinin hazırlanması (evlilik sözleşmeleri), boşanmanın mali sonuçlarına ilişkin nafaka ve tazminat davaları, Edinilmiş mallara katılım alacağı davaları, aile konutu, velayet, nesebin tashihi ve babalık davası ve evlat edinme işlemleri
                            </p>
                            <p>
                                Boşanma ve aile hukuku davalarınız sürecinde gerekli yardım ve desteği alabileceğiniz Bursa boşanma avukatı olarak hizmet vermekteyiz.
                            </p>
                        </div>
                    </div>
                        ...
                        <div className="sticky top-32">
                            ...
                            <div className="bg-gray-50 border border-gray-200 p-6">
                                ...
                                <p className="text-gray-600 text-sm mb-6">
                                    Aile hukuku konusunda profesyonel destek için formu doldurun, en kısa sürede size dönüş yapalım.
                                </p>
...
export default AileBosanmaHukuku;