                        ...
                        <div className="sticky top-32">
                            ...
                            <div className="bg-gray-50 border border-gray-200 p-6">
                                ...
                                <p className="text-gray-600 text-sm mb-6">
                                    Gayrimenkul ve miras hukuku konusunda profesyonel destek için formu doldurun, en kısa sürede size dönüş yapalım.
                                </p>
...
export default GayrimenkulMirasHukuku;